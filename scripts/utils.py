...
def print_with_color(text: str, color=""):
    if color == "red":
        print(Fore.RED + json.dumps(text))
    elif color == "green":
        print(Fore.GREEN + json.dumps(text))
    elif color == "yellow":
        print(Fore.YELLOW + json.dumps(text))
    elif color == "blue":
        print(Fore.BLUE + json.dumps(text))
    elif color == "magenta":
        print(Fore.MAGENTA + json.dumps(text))
    elif color == "cyan":
        print(Fore.CYAN + json.dumps(text))
    elif color == "white":
        print(Fore.WHITE + json.dumps(text))
    elif color == "black":
        print(Fore.BLACK + json.dumps(text))
    else:
        print(text)
